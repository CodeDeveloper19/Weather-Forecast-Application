...
function loading() {
    ...
    navigator.permissions.query({name:'geolocation'}).then(function(result) { // checks if the user has previously granted permisssion to the browser to use location
        if (result.state === 'granted') {
            ...
            document.getElementById("consent").style.left = "200px";
...
document.getElementById("no").addEventListener('mouseover', () => {
    document.getElementById("animated").src = "other icons/sad cloud.png"
})

document.getElementById("no").addEventListener('mouseout', () => {
    document.getElementById("animated").src = "other icons/animated.gif"
})

document.getElementById("yes").addEventListener('mouseover', () => {
    document.getElementById("animated").src = "other icons/sun.png"
})

document.getElementById("yes").addEventListener('mouseout', () => {
    document.getElementById("animated").src = "other icons/animated.gif"
})
